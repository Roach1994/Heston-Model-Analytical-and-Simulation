...
import math
#import ql_exact
def MilsteinHeston(kappa, theta, beta, rho, v0 ,r ,T ,s0 ,K,N,dt):
    ...
    for i in range (0,Ntime):   
        ...
        v=v+kappa*dt*(theta-vreal)+beta*np.multiply(sqrt(vreal),Zv)*sqrt_dt+1/4*beta*beta*dt*(np.power(Zv,2)-1)
...
if __name__ == '__main__':
    ...
    for i in range(0,3):
        print (MilsteinHeston(kappa, theta, beta, rho, v0, r, T, s0, K[i].item(),10000,1/32))
